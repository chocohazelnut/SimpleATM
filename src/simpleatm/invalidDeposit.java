...
public class invalidDeposit extends javax.swing.JFrame {

    public invalidDeposit() {
        initComponents();
        curBal.setText("" + addbalance);
        statusLabel.setText("contains zero balance!");
    }
    ...
    private void initComponents() {
        ...
        statusLabel.setFont(new java.awt.Font("Yu Gothic UI", 1, 24)); // NOI18N
        statusLabel.setForeground(new java.awt.Color(255, 255, 255));
        statusLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        statusLabel.setText("is greater than your current balance!");
